...
export class GetCategoryItemAttributesRequest extends SpeakeasyBase {
  /**
   * 24-character system-generated category ID. `id` and `nodeId` are the two identifiers of a category. <br> **Note**: If `id` is specified, `status` must be specified as well.
   */
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=id" })
  id?: string;

  /**
   * Human-readable category ID. `id` and `nodeId` are the two identifiers of a category. <br> **Note**: If `nodeId` is specified, `status` must be specified as well.
   */
  @SpeakeasyMetadata({
