...
export class Attributes {
  ...
  modifyAttributeGroups(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/api-product/v1/product/attribute-group";
  ...
  modifyAttributeMappings(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api-product/v1/product/attribute/mapping";
  ...
  postCategoryAttributeBulk(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api-category/v1/category/attribute/bulk";
  ...
  postProductAttributeBulk(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api-product/v1/product/attribute/bulk";
